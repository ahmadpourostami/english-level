...
class ELA_DB {
 ...
 public static function save_result($user_id,$score,$level,$skills){global $wpdb;$table=$wpdb->prefix.'ela_results';return $wpdb->insert($table,['user_id'=>$user_id,'score'=>$score,'level'=>$level,'skills'=>wp_json_encode($skills),'created_at'=>current_time('mysql')]);}
